...
This chapter introduces the concepts that will lay the foundation for the rest of the thesis. Section~\ref{sec:bg_gait} describes gait signals and how they are captured with inertial sensors. Section~\ref{sec:bg_auth} explains the distinction between identification and authentication and how deep learning architectures are adapted for the authentication task. Section~\ref{sec:bg_privacy} covers the connection between model memorisation and privacy risk. Section~\ref{sec:bg_mia} formalises membership inference attacks and describes the likelihood ratio formulation used in this work.
